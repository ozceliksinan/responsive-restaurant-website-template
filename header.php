...
<head>
    ...
    <title>Restaurant Cafe Template</title>
    <!-- Google Fonts -->
...
<body class="home">
    ...
    <header id="header-1" class="headerHolder header-1">
        ...
        <div class="logo logo-1"><a href="index.php"><img class="img-fluid" src="images/logo.png" alt="" /></a></div>
        ...
        <div class="social-btn-top1">
            ...
            <div class="btn-header btn-header1"> <a href="reservation.php" class="view-more">Book a Table</a>
            </div>
        </div>
    </header>
    <!-- /HEADER -->